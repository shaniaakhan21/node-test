...
const Index = () => {
    ...
    const tableColumns = [
        ...
        { Header: "Date & Time", accessor: "dateTime", cell: (cell) => moment(cell?.value).format("DD MMM YYYY, hh:mm A") },
        { Header: "Time Stamp", accessor: "timestamp", cell: (cell) => moment(cell?.value).format("DD MMM YYYY, hh:mm A") },
        {
            Header: "Create By", accessor: (row) => {
                const firstName = row?.createBy?.firstName || '';
                const lastName = row?.createBy?.lastName || '';
    ...
    const fetchData = async () => {
        ...
        console.log("🎯 Refetched data:", result.payload?.data);
